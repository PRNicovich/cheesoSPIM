...
- Arduino
	Arduino Uno is used to translate USB serial commands into pin toggles and motion. Commands to move the Canon lens and theta motor, plus control laser power are included in the associated sketch. Any similar microcontroller could be substituted. 
